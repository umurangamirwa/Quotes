...
export class AppComponent {
    Quotes = [
        ...
        new Quotes(5, 'Solve math homework','Live life to the fullest and focus on the positive',new Date(2005,8,9)),
        new Quotes(6, 'Plot my world domination plan','I love the way Pharell is laying down great drum tracks. He is a great drummer',new Date(2005,9,8)),
